<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="../template_spp/master-konten.php">Pembayaran  SPP</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="../template_spp/master-konten.php">SPP</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li >
              <a href="../Admin/dashboard-admin.php" class="nav-link "><i class="fas fa-anchor"></i><span>Dashboard</span></a>
            </li>
            <li >
